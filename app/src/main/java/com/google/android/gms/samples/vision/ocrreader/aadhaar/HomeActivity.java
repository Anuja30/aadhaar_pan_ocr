package com.google.android.gms.samples.vision.ocrreader.aadhaar;
...
import com.google.android.gms.samples.vision.ocrreader.aadhaar.utils.DataAttributes;
import com.google.android.gms.samples.vision.ocrreader.aadhaar.utils.Storage;
...
public class HomeActivity extends AppCompatActivity {
    ...
    LinearLayout ll_scanned_data_wrapper,ll_data_wrapper,ll_action_button_wrapper, ll_scan_qr_wrapper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_scan_qr_wrapper = (LinearLayout) findViewById(R.id.ll_scan_qr_wrapper);

        final int rc = ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA);

        ll_scan_qr_wrapper.setOnClickListener(new View.OnClickListener() {
            @Override
